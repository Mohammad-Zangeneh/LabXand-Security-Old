...
(function () {
     ...
     * ng date picker
     */
    angular.module('nodak.components').directive('ngDatePicker', ['$parse', directive]);
    ...
    function directive($parse)
    {
        ...
        var datePicker = function datePicker() {
            ...
            debugger;
            var _shanbeh = 'شنبه',
                _dayName = new Array(_shanbeh, '1' + _shanbeh, '2' + _shanbeh,'3' + _shanbeh, '4' + _shanbeh, '5' + _shanbeh, 'جمعه'),
            ...
            function draw(date) {
                ...
                button = createElement("button", td);
                setInnerHTML(button, "تاریخ امروز");
                button.onclick = function () {
                    setValue(_today);
                };
