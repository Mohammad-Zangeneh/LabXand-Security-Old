var Drawchart = function (list, el) {
    var svg = d3.select(el), width = +svg.attr("width"), height = +svg.attr("height"), g = svg.append("g").attr("transform", "translate(20,0)"); // move right 20px.
    // x-scale and x-axis
    var experienceName = ["", "متوسط 1.0", "مبتدی 2.0", "بسیارخوب 3.0", "ماهر 4.0", "متخصص 5.0"];
